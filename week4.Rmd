...
# read the data
diplo <- read.csv("data_week4/Diplomatic_Exchange_2006v1.csv")
...
# read the data
trade <- read.csv("data_week4/Dyadic_COW_4.0.csv")
...
```{r ally}
ally <- read.csv("data_week4/alliance_v4.1_by_directed.csv")
...
```{r igo }
igo <- read.csv("data_week4/dyadic_formatv3.csv")
...
```{r mid}
mid <- read.csv( "data_week4/dyadic_mid_4.02.csv") 
